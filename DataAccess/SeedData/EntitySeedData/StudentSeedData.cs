        ...
        public void Configure(EntityTypeBuilder<Student> builder)
        {
            builder.HasData
                (
                    new Student
                    {
                        Id = "7b0de540-cc70-46bd-9ec2-235279e9129e",
                        FirstName = "Dicle",
                        LastName = "Göya",
                        BirthDate = new DateTime(1993, 04, 18),
                        Email = "dicle.goya@bilgeadam.com",
                        ClassroomID = "50162998-279b-41b8-a2c2-7e5e40315498",
                        AppUserId = "676452dd-8a1c-4747-8252-9ba2642917ea"
                    },
                    new Student
                    {
                        Id = "1a1a8b40-ff70-46bd-9ec2-235279e9129e",
                        FirstName = "İsmail",
                        LastName = "Danışmaz",
                        BirthDate = new DateTime(1995, 06, 15),
                        Email = "ismail.danismaz@bilgeadam.com",
                        ClassroomID = "50162998-279b-41b8-a2c2-7e5e40315498",
                        AppUserId = "f78a22b2-e756-485f-8729-88003bacf1ff"
                    }
                );
        }
    }
